...
import (
	...
	"github.com/alexsotocx/proglog/internal/auth"
	"github.com/alexsotocx/proglog/internal/config"
	"github.com/alexsotocx/proglog/internal/log"
)
...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	if *debug {
		metricLogFile, err := ioutil.TempFile("", "metrics-*.log")
