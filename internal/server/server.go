...
func NewGRPCServer(config *Config, opts ...grpc.ServerOption) (*grpc.Server, error) {
	server_interceptor := grpc_middleware.ChainStreamServer(grpc_auth.StreamServerInterceptor(authenticate))
	unary_interceptor := grpc_middleware.ChainUnaryServer(grpc_auth.UnaryServerInterceptor(authenticate))
	opts = append(opts, grpc.StreamInterceptor(server_interceptor), grpc.UnaryInterceptor(unary_interceptor))
